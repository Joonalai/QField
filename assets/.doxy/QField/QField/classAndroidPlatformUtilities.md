...
| virtual [**ResourceSource**](classResourceSource.md) \* | [**getFile**](#function-getfile) (const QString & prefix, const QString & filePath, const QString & filter, QObject \* parent=nullptr) override<br> |
...
| virtual Q\_INVOKABLE [**ResourceSource**](classResourceSource.md) \* | [**getFile**](classPlatformUtilities.md#function-getfile) (const QString & prefix, const QString & filePath, const QString & filter=tr("All files (\*.\*)"), QObject \* parent=nullptr) <br> |
